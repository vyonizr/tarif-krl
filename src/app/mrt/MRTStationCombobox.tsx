...
interface MRTStationComboboxProps {
  stations: IMRTStation[]
  selectedStation: IMRTStation | null
  onSelect: (station: IMRTStation) => void
  placeholder: string
  disabled?: boolean
}

export default function MRTStationCombobox({
  stations,
  selectedStation,
  onSelect,
  placeholder,
  disabled = false,
}: MRTStationComboboxProps) {
